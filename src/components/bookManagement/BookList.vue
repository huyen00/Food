<template>
  <div>
    ...
    <div
      ...
      <div class="item_book transition duration-500 ease-in-out transform " v-for="book in books"
        :key="book.id">
    ...
    <nav v-if="pagination" class="m-4">
          <ul class="pagination justify-center">
            <li class="page-item" :disabled="currentPage === 1 ? true : false">
              <a class="page-link text-gray-500" href="#" @click.prevent="changePage(currentPage - 1)">previous</a>
            </li>
            <li v-for="page in pagesNumber" :key="page" class="page-item"
              :class="{ active: page == pagination.meta.current_page }">
              <a  @click.prevent="changePage(page)" class="page-link text-gray-500">{{ page
              }}</a>
            </li>
